<?php
    ...
    class Bundle extends Command {
        ...
        public function run(Application $app, ?string ...$args): void
        {
            ...
            // Alpine scripts - App
            $output = $app->execute("find ./app/ -type f -name \"*.js\" -print | xargs basename -s .js | xargs -I {} uglifyjs {}.js --output {}.min.js");
            $app->output($output);

            // Alpine scripts - Native
            $output = $app->execute("find ./native/views/assets/scripts/components/ -type f -name \"*.js\" -print | xargs basename -s .js | xargs -I {} uglifyjs {}.js --output {}.min.js");
