<?php
    ...
    class Bundle extends Command {
        ...
        protected array $dependencies = [ 'tailwind' , 'uglifyjs' , 'cssnano' ];
        ...
        public function run(Application $app, ?string ...$args): void
        {
            ...
            // CSSNano
            $output = $app->execute("cssnano < ./native/views/assets/styles/tw.css > ./native/views/assets/styles/tw.min.css");
